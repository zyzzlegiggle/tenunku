...
class _BuyerWhatsappNotificationsPageState
  ...
  Map<String, dynamic> _settings = {'whatsapp': false, 'whatsapp_orders': true};
                        ...
                        Container(
                          ...
                          child: Column(
                            children: [
                              _buildSwitchItem(
                                'Notifikasi WhatsApp',
                                _settings['whatsapp'] ?? false,
                                (val) => _updateSetting('whatsapp', val),
                              ),
                              _buildDivider(),
                              Opacity(
                                opacity: (_settings['whatsapp'] ?? false)
                                    ? 1.0
                                    : 0.5,
                                child: IgnorePointer(
                                  ignoring: !(_settings['whatsapp'] ?? false),
                                  child: Column(
                                    children: [
                                      _buildSwitchItem(
                                        'Pesanan',
                                        _settings['whatsapp_orders'] ?? true,
                                        (val) => _updateSetting(
                                          'whatsapp_orders',
                                          val,
                                        ),
